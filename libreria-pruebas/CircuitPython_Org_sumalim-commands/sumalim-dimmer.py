...
print(bytearray.fromhex("1002190100050101FFFFFFFF00100005FF00DC05F401551003"))
print(list(bytearray.fromhex("1002190100050101FFFFFFFF00100005FF00DC05F401551003")))
print(CommandFromInput("1002190100050101FFFFFFFF00100005FF00DC05F401551003"))
