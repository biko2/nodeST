...
print("1002180100050101FFFFFFFF808080020AF401F401551003")
print("--------[modo lista:")
print(list(bytearray.fromhex("1002180100050101FFFFFFFF808080020AF401F401551003")))
print("--------[string:")
print(bytearray.fromhex("1002180100050101FFFFFFFF808080020AF401F401551003"))
print("--------[parsedInput:")
print(CommandFromInput("1002180100050101FFFFFFFF808080020AF401F401551003"))
...
command = createCommand.led(1,0,5,1, 255, 255, 255, 255, 128, 128, 128 , 2, [10,255,255])
print(command)
